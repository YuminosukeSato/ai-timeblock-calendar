...
### UI Flow Demo (Playwright)

The GIF below was generated by Playwright automation.
Flow: open app -> create time block -> drag and move event -> switch to Gantt -> back to Week.

![AI Time Block Calendar UI Flow](docs/demo/timeblock-flow.gif)
